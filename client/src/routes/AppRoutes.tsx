      ...
      <Route element={<ProtectedRoute />}>
        <Route path="/" element={<AppLayout />}>
          ...
          <Route
            path="students"
            element={
              <RequireAccess roles={[UserRole.SUPER_ADMIN, UserRole.TEACHER]} permissions={[Permission.VIEW_STUDENTS]}>
                <StudentsPage />
              </RequireAccess>
            }
          />
          ...
          <Route
            path="enrollments"
            element={
              <RequireAccess roles={[UserRole.SUPER_ADMIN, UserRole.TEACHER]} permissions={[Permission.VIEW_ENROLLMENTS]}>
                <EnrollmentsPage />
              </RequireAccess>
            }
          />
          ...
          <Route
            path="reports"
            element={
              <RequireAccess roles={[UserRole.SUPER_ADMIN, UserRole.TEACHER]} permissions={[Permission.VIEW_REPORTS]}>
                <ReportsPage />
              </RequireAccess>
            }
          />
