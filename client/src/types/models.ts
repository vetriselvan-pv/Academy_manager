...
export function isPopulated<T extends { _id: string }>(ref: T | string | undefined): ref is T {
...
export function refLabel(ref: { name: string } | string | undefined, fallback = 'Unknown'): string {
